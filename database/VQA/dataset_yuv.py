...
class VideoDataset(Dataset):
    ...
    def __init__(self, subj_score_file, directory, mode='train', channel=1, size_x=112, size_y=112, stride_x=80, stride_y=80, frameWant=32, transform=None, crossMode=''):
    ...
    def __getitem__(self, index):
        ...
        if dis.endswith(('.YUV', '.yuv')):
            ...
            dis = self.load_mp4(dis, frame_height, frame_width, stride_t, frameWant=self.frameWant, transform=self.transform)
